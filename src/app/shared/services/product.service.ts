...
export class ProductService {
  ...
  */
	...
	addFavouriteProduct(data: Product): void {
		...
		a.push(data);
		this.toastrService.wait('Agregando Producto', 'Producto agregado a favoritos');
		setTimeout(() => {
  ...
  */
	...
	addToCart(data: Product): void {
		...
		a.push(data);
		this.toastrService.wait('Agregando Producto a tu carrito', 'Producto Agregado Exitosamente');
		setTimeout(() => {
